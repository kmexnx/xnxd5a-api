...
declare type Middlware = (req: Request, res: Response, next: NextFunction) => any;
export declare function Middleware(middleware: Middlware | Middlware[]): MethodDecorator;
export {};
